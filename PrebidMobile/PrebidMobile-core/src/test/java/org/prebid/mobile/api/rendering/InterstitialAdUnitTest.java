...
public class InterstitialAdUnitTest {
    ...
    public void onFailedAndNoWinnerBid_AdStatusReadyForLoadNotifyErrorListener() {
        ...
        verify(mockInterstitialAdUnitListener, times(1)).onAdFailed(interstitialAdUnit, new AdException(AdException.FAILED_TO_LOAD_BIDS, "GAM status: \"Exception: SDK internal error, GAM error\". Prebid status: \"Exception: SDK internal error, Unknown exception\""));
        assertEquals(READY_FOR_LOAD, interstitialAdUnit.getAdUnitState());
    }
